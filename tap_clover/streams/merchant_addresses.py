...
class MerchantAddressesStream(CloverStream):
    """Stream for retrieving merchant address records from the CloverStream API."""
    ...
    def path(self) -> str:
        ...
        return f"/v3/merchants/{merchant_id}/address"
