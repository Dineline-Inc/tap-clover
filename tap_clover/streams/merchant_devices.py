...
class MerchantDevicesStream(CloverStream):
    """Stream for retrieving merchant device records from the CloverStream API."""

    name = "merchant_devices"
    ...
    def path(self) -> str:
        ...
        return f"/v3/merchants/{merchant_id}/devices"
