...
class InventoryItemGroupsStream(CloverStream):
    """Stream for retrieving inventory item group records from the CloverStream API."""

    name = "inventory_item_groups"
    ...
    def path(self) -> str:
        ...
        return f"/v3/merchants/{merchant_id}/item_groups"
