...
class InventoryAttributesStream(CloverStream):
    """Stream for retrieving inventory attribute records from the CloverStream API."""
    ...
    def path(self) -> str:
        ...
        return f"/v3/merchants/{merchant_id}/attributes"
