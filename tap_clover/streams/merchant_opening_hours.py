...
class MerchantOpeningHoursStream(CloverStream):
    """Stream for retrieving merchant opening hour records from the CloverStream API."""
    ...
    def path(self) -> str:
        ...
        return f"/v3/merchants/{merchant_id}/opening_hours"
